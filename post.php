...
if ($conn) {
	$sql = "SELECT publicaciones.*, categorias.nombreCat, usuarios.nombreUsr, usuarios.apellido
			...
			WHERE publicaciones.categoria_id = categorias.categoria_id AND publicaciones.eliminado =0 AND publicaciones.usuario_id = usuarios.usuario_id AND publicaciones.publicacion_id = :id";
	$parametros = array();
